...
# Conclusion
The p-dispersion problem is sometimes overlooked when compared to its more frequent counterparts that simply maximize an objective function without an inherent minimization. Nevertheless, there are many important applications of the p-dispersion problem as explained above. This assignment showed the combinatorial nature of the p-dispersion problem, and some simple relationships between runtime, our variable $Z,$ and the number of facilities.
